...
def insert_slice_rows(slice_no): #slice_no = 1, 2, 3, ...
    ...
    label_slice.grid(row=3*(slice_no-1)+1, column=0, sticky="nsew", columnspan=1, rowspan=3, padx=1, pady=(1,3))
    ...
    label_n_flows.grid(row=3 + 3 * (slice_no - 1), column=1, sticky="nsew", columnspan=1, rowspan=1, padx=1, pady=(1,3))
...
label_sl_sw = Label(tab2, text="Slice \ Switch", bg="#0059b3", fg="white", padx=3,pady=3) #, anchor = "n"
