...
class MyTopo(Topo):
	...
	def __init__(self):
		...
		h2 = self.addHost('h2', ip='20.0.0.2', mac='aa:aa:aa:aa:aa:02')
		h3 = self.addHost('h3', ip='10.0.0.3', mac='aa:aa:aa:aa:aa:03')
		h4 = self.addHost('h4', ip='20.0.0.4', mac='aa:aa:aa:aa:aa:04')
		h5 = self.addHost('h5', ip='10.0.0.5', mac='aa:aa:aa:aa:aa:05')
		h6 = self.addHost('h6', ip='20.0.0.6', mac='aa:aa:aa:aa:aa:06')
