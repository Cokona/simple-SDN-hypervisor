...
if __name__ == '__main__':
    try:
        ...
        call(['gnome-terminal', '-e', "sudo mn --custom Project/Topologies/sdn_topo_dyn.py --topo=mytopo --controller=remote,ip=127.0.0.1,port=65432,protocols=OpenFlow13 --mac"])
